...

{
...

    {
        ...
        public ShellViewModel(WorkspaceCoordinator workspaceCoordinator, SmtpSettingsCoordinator smtpCoordinator)
        ...
        public partial string WorkspaceName { get; set; } = "Seminar-FTI";



        [ObservableProperty]

        public partial string StatusWorkspaceName { get; set; } = "Seminar-FTI";
